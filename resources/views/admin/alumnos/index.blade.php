  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="float-left text-dark font-weight-bold ">Colegio LATINO - Modulo de Registro Asistencia</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class='card-header'>
                                <h3>Marcar Asistencia de Alumnos</h3>
                                </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
